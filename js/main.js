class Button {
    ...
    colorChange(){ //changes the color to the color in action
    ...
    colorOriginal(){ //changes the color to the color in action
...
const metroArray = [Metro1,Metro2,Metro3,Metro4,Metro5,Metro6,Metro7,Metro8];
